...
public class MenuEquip {
	...
	private static void removeEquip() {
		...
		if(Repositorio.equipamento.containsKey(nome)) {
			...
			JOptionPane.showMessageDialog(null, "Equipamento não encontrado ou inexistente!");
			menu();
	...
	private static void verEquips() {
		...
		JOptionPane.showMessageDialog(null, "Atualmente, esses são os equipamentos disponíveis: " + Repositorio.equipamento.keySet());
		JOptionPane.showMessageDialog(null, "E estas são suas respectivas quantidades: " + Repositorio.equipamento.values());
		menu();
